...
namespace Hurricane\Tests\Erlang;

use \Hurricane\Erlang\Util;
use \Hurricane\Erlang\DataType;
use \Hurricane\Erlang\StreamEmulator;
...
class UtilTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDecodeAtomCacheRef()
    {
        ...
        $expected = new DataType\AtomCacheRef(1);

        $stream = new StreamEmulator($input);
        $actual = Util::decode($stream);
    ...
    public function testDecodeAtom()
    {
        ...
        $expected = new DataType\Atom('ilia_atom');
    ...
    public function testDecodeReference()
    {
        ...
        $expected = new DataType\Reference(
            new DataType\Atom('ilia_atom'), 16843009, 42
        );
    ...
    public function testDecodePort()
    {
        ...
        $expected = new DataType\Port(
            new DataType\Atom('nonode@nohost'), 501, 0
        );
    ...
    public function testDecodePid()
    {
        ...
        $expected = new DataType\Pid(
            new DataType\Atom('nonode@nohost'), 31, 0, 0
        );
    ...
    public function testDecodeSmallTuple()
    {
        ...
        $expected = new DataType\Tuple(array(42, 69));
    ...
    public function testDecodeLargeTuple()
    {
        ...
        $expected = new DataType\Tuple(array(
    ...
    public function testDecodeBinary()
    {
        ...
        $expected = new DataType\Binary('now get your ass to mars');
    ...
    public function testDecodeNewReference()
    {
        ...
        $expected = new DataType\NewReference(
            new DataType\Atom('nonode@nohost'), 0, array(0, 0, 94)
        );
    ...
    public function testDecodeSmallAtom()
    {
        ...
        $expected = new DataType\Atom('abcd');
    ...
    public function testDecodeExport()
    {
        ...
        $expected = new DataType\Export(
            new DataType\Atom('erlang'), new DataType\Atom('self'), 0
        );
    ...
    public function testDecodeNewFunction()
    {
        ...
        $expected = new DataType\NewFunction(
            0, "\xb8\x8f\x81\x94 \x91?\xb3[\xc9\x96^\x97a:\xe3", 1,
            new DataType\Atom('erl_eval'), 20, 67289768,
    ...
    public function testDecodeFunction()
    {
        ...
        $expected = new DataType\ErlFunction(
            new DataType\Pid(
                new DataType\Atom('nonode@nohost'), 31, 0, 0
            ),
    ...
    public function testDecodeBitBinary()
    {
        ...
        $expected = new DataType\BitBinary(4, "\xc3\x8b\x1e@");
    ...
    /**
     ...
     {
         $input = new DataType\BitBinary(4, "\xc3\x8b\x1e@");
     ...
     {
         $input = new DataType\AtomCacheRef(1);
     ...
     {
         $input = new DataType\Atom('ilia_atom');
         $expected = array(
     ...
     {
         $input = new DataType\Atom('ilia_atom_is_quite_a_long_atom');
         $expected = array(
     ...
     {
         $input = new DataType\Reference(
             new DataType\Atom('nonode@nohost'), 69, 0
         );
         $expected = array(
     ...
     {
         $input = new DataType\Pid(
             new DataType\Atom('nonode@nohost'), 69, 0, 0
         );
         $expected = array(
     ...
     {
         $input = new DataType\Tuple(range(0, 9));
         $expected = array(
     ...
     {
         $input = new DataType\Tuple(range(0, 400));
         $expected = array(
     ...
     {
         $input = new DataType\Binary('abcd');
     ...
     {
         $input = new DataType\NewReference(
             new DataType\Atom('nonode@nohost'), 0, array(0, 0, 94)
         );
         $expected = array(
     ...
     {
         $input = new DataType\NewFunction(
             0, "\xb8\x8f\x81\x94 \x91?\xb3[\xc9\x96^\x97a:\xe3", 1,
             new DataType\Atom('erl_eval'), 20, 67289768,
             new DataType\Pid(new DataType\Atom('nonode@nohost'), 31, 0, 0),
             array()
